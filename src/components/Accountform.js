                ...
                <form onSubmit={this.submitHandle}>
                    <div class="row">
                        <div class="col-md-3 border-right">
                            ...
                            <div id='centerit' class="col-md-6"><label class="labels">Image Link:</label><input onChange={this.handleChangeDegree} type="text" class="form-control" placeholder="Image Link" /></div>
                        </div>
